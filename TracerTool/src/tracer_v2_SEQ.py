...
from .component_v1 import Component
import os
...
# Clock methods
    ...
    def check_controller_clocks(self, components):
        for i, component1 in enumerate(components):
            ...
            for component2 in components[i+1:]:
                ...
                # next function has same parts (done this way for (theoretical) efficiency (less function overhead)) 
    ...
    def check_controller_switch_clocks(self, controllers, switches):
        for c in controllers:
            ...
            for sw in switches:
                swc = sw.v_clock
                # previous function has same parts (done this way for (theoretical) efficiency (less function overhead)) 
