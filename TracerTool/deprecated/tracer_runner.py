...
# core classes
from TracerTool.deprecated.component import Component
from TracerTool.deprecated.tracer_v1 import TracerTool
...
# showcase of TracerTool
    def showcase(self):
        ...
        if self.graph_type is None or self.graph_type == 'full':
            ...
            tracer_full.make_and_save_graph(f'GRAPH_FULL_unfold_SEQ{img_format}')
        ...
        if self.graph_type is None or self.graph_type == 'race':
            ...
            # race graph
            tracer_race.make_and_save_race_graph(f'GRAPH_ONLY_RACES_unfold_SEQ{img_format}')
